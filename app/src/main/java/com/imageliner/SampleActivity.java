...
public class SampleActivity extends BaseActivity implements UCropFragmentCallback {
    ...
    private void setupUI() {
        ...
        mTextViewQuality.setText(String.format(getString(R.string.dialog_ok), mSeekBarQuality.getProgress()));
        mSeekBarQuality.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mTextViewQuality.setText(String.format(getString(R.string.action), progress));
            }
