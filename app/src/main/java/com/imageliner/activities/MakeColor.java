...
public class MakeColor extends AppCompatActivity{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            imageVIewInput = (ImageView)findViewById(R.id.imageViewInputc);
            imageVIewOuput = (ImageView)findViewById(R.id.imageViewOutputc);

            Button Button = (android.widget.Button)findViewById(R.id.buttonc);
            ...
            final TextView textView1 = (TextView)findViewById(R.id.textView_threshold1c);
            SeekBar seekBar1=(SeekBar)findViewById(R.id.seekBar_threshold1c);
            ...
            final TextView textView2 = (TextView)findViewById(R.id.textView_threshold2c);
            SeekBar seekBar2=(SeekBar)findViewById(R.id.seekBar_threshold2c);
        ...
        private void showDialogforPermission(String msg) {
            ...
            final AlertDialog.Builder myDialog = new AlertDialog.Builder(  MakeColor.this);
